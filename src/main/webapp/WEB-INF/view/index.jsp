...
<head>
    ...
    <title>Alcohol Free Price</title>
    ...
    <style>
        *{margin: 0; padding: 0;box-sizing: border-box;}
        ...
        section{padding-left: 220px ;width: 100%; height: 2000px; background-color: rgb(255, 235, 238);float: left;}
        button{background-color: rgb(204, 193, 218); border:2px solid rgb(217, 150, 148); padding: 5px; border-radius: 20%; }
        .rounded-button {display: inline-block; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer;}
        .in_main{width: 880px;}
...
<c:when test="${empty loginedInfo }">
        <form action = "${pageContext.request.contextPath}/login" method="post">
            <div class="in_side_input">
                ...
                <button type="button" class="rounded-button" style="text-align: right;">JOIN</button>
